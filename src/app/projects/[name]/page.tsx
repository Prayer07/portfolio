...
const projects: Record<string, { title: string; desc: string; github:string; deploy: string }[]> = {
  javascript: [
    {
      title: "Clock-App",
...
export default function ProjectDetailsPage() {
  ...
  const projectList = projects[name as string] || [];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-yellow-400 mb-4">
            {name?.toString().toUpperCase()} Projects
          </h1>
          <p className="text-gray-400">
            Here are some projects I’ve built with {name}.
          </p>
        </div>
