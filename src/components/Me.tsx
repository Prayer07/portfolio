...
export default function Me() {
    return (
    <>
        <div id='me' style={{textAlign:"center"}}>
            <p style={{fontWeight:"bold"}}>
                ...
                in Computer Science. <br />Attended a boot-camp called <Link href={"/gomycode.co"} style={{color: "black"}}>GOMYCODE</Link>during my IT where i learnt how to build both frontend and backend applications with these tech skills;<br /> HTML, CSS, Javascript(JS) and React (Frontend skills), Typescript(TS), Next.js,
